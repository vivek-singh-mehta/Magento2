...
class CreateCustomersJson extends Command
{
  private $filesystem;
  private $customer;
  private $state;
  ...
  public function execute(InputInterface $input, OutputInterface $output): ?int
  {
    try {
      ...
      $import_file = pathinfo($import_path); 
        //print_r($import_file['extension']); exit();
     ...
     echo 'Customer import successfully through JSON file';
  ...
  public function configure(): void
  {
    ...
    $this->setDescription('Imports customers into Magento from a Json');
